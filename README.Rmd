...
[![packageversion](https://img.shields.io/badge/Package%20version-`r gsub('-', '.', as.vector(read.dcf('DESCRIPTION')[, 'Version']))`-orange.svg?style=flat-square)](commits/master) [![thanks-md](https://img.shields.io/badge/THANKS-md-ff69b4.svg)](THANKS.md)
