# hawkinR ![](reference/figures/hdlogo.png)
...
- [`get_access()`](https://hawkindynamics.github.io/hawkinR/reference/get_access.md) -
  Use the Refresh Token generated
...
- [`get_testTypes()`](https://hawkindynamics.github.io/hawkinR/reference/get_testTypes.md) -
...
- [`get_athletes()`](https://hawkindynamics.github.io/hawkinR/reference/get_athletes.md) -
  Get the athletes for an account. Inactive players will only be
  included if \`inactive\` parameter is set to TRUE. Response will be a
  data frame containing the athletes that match this query.

- [`get_teams()`](https://hawkindynamics.github.io/hawkinR/reference/get_teams.md) -
  Get the team names and ids for all the teams in the org. Response will
  be a data frame containing the teams that are in the organization.

- [`get_groups()`](https://hawkindynamics.github.io/hawkinR/reference/get_groups.md) -
  Get the group names and ids for all the groups in the org. Response
  will be a data frame containing the groups that are in the
  organization.

#### Get Test Data

- [`get_forcetime()`](https://hawkindynamics.github.io/hawkinR/reference/get_forcetime.md) -
  ...
  Calculated velocity, displacement, and power at each time interval
  will also be included.

- [`get_tests()`](https://hawkindynamics.github.io/hawkinR/reference/get_tests.md) -
  Get the tests for an account. You can specify none or any 1 of the
  parameters athlete, test type, teams or groups; as well as a time
...
See*
[`get_tests()`](https://hawkindynamics.github.io/hawkinR/reference/get_tests.md)
*for the preferred function.*

- [`get_tests_type()`](https://hawkindynamics.github.io/hawkinR/reference/get_tests_type.md) -
  ***Deprecated*** Get only tests of the specified type for an account.
  Response will be a data frame containing the trials of the specified
  type and within the time range (if specified).

- [`get_tests_ath()`](https://hawkindynamics.github.io/hawkinR/reference/get_tests_ath.md) -
  ***Deprecated*** Get only tests of the specified athlete for an
...
- [`get_tests_team()`](https://hawkindynamics.github.io/hawkinR/reference/get_tests_team.md) -
  ***Deprecated*** Get only tests of the specified team for an account.
  Response will be a data frame containing the trials from the specified
  team and within the time range (if specified).

- [`get_tests_group()`](https://hawkindynamics.github.io/hawkinR/reference/get_tests_group.md) -
  ***Deprecated*** Get only tests of the specified group for an account.
  Response will be a data frame containing the trials from the specified
  team and within the time range (if specified).
